#Input parameters
refTree_file <- "~/devel/R/flowJo_merge/refTrees/refTree_2021_10_15_EVD.yml" #Text file with reference tree and aliases

cohort_folder <- "/Volumes/Groups/GroupDeVisser/data/Hannah/Human blood/BELLINI" # Data folder containing samples
output_xlsx <- "~/devel/R/flowJo_merge/output/2021_10_15/bellini.xlsx" #Output xlsx file with population frequency counts
